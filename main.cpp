...
int main() {
    ...
    Cube cube2(glm::vec3(0.0f, 0.0f, -1.0f));
    Cube cube3(glm::vec3(1.0f, 1.0f, 1.0f));

    Cube cubeGrande(glm::vec3(0.0f, 0.0f, 0.0f),    // posição à direita
                    glm::vec3(0.0f),                 // sem rotação inicial
                    glm::vec3(2.0f, 0.03f, 2.0f));

    // Ativa depth test
    //glEnable(GL_DEPTH_TEST);

    Cylinder cilindro(glm::vec3(1.0f, 1.0f, 1.0f));

    Sphere esfera(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f), glm::vec3(1.0f));

    Prism prisma(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f), glm::vec3(1.0f));
